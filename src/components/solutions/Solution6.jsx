      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-12">
            <Swiper {...slider} className="swiper home6-solution-slider">
              <div className="swiper-wrapper">
                <SwiperSlide className="swiper-slide">
                  <div className="single-solution">
                    <div className="background-img">
                      <img
                        src="assets/img/home-6/home6-solution-bg2.png"
                        alt=""
                      />
                    </div>
                    <div className="sl">
                    ...
                    <div className="solution-content">
                      ...
                      <p>
                        ...
                        web applications for the internet or intranet.
                      </p>
                    </div>
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="single-solution">
                    <div className="background-img">
                      <img
                        src="assets/img/home-6/home6-solution-bg3.png"
                        alt=""
                      />
                    </div>
                    <div className="sl">
                    ...
                    <div className="solution-content">
                      ...
                      <p>
                        Software development is the process of creating computer
                        software programs that perform specific functions or
                        tasks.
                      </p>
                    </div>
                    <div className="solution-btn-icon">
                ...
                <SwiperSlide className="swiper-slide">
                  <div className="single-solution">
                    <div className="background-img">
                      <img
                        src="assets/img/home-6/home6-solution-bg4.png"
                        alt=""
                      />
                    </div>
                    <div className="sl">
                    ...
                    <div className="solution-content">
                      ...
                      <p>
                        Cloud solutions refer to the use of cloud computing
                        technology to provide services and solutions over the
                        internet.
                      </p>
                    </div>
                    <div className="solution-btn-icon">
        ...
        <div className="row">
          <div className="col-12">
            <div className="paginations">
              <div className="swiper-pagination61" />
            </div>
          </div>
        </div>
      </div>
